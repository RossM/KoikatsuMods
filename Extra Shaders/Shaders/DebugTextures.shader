...
////// Emissive:
                ...
                float2 matcapUV = saturate(lerp(GetMatcapUV( normalDirection , viewDirection ),((reflectedViewPosition.rg/length((reflectedViewPosition+float3(0,0,1))))*0.5+0.5),_MatcapMode));
