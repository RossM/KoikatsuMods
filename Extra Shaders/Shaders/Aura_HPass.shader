...
Shader "Custom/Aura_HPass" {
    ...
    SubShader {
        ...
        Pass {
            ...
            return HPass(uv, radius * noiseExtend);
            }
...
////// Emissive:
                ...
                return fixed4(finalColor,GetAlpha( sceneUVs.rg , ((r*0.1+0.0)*(1.0 / centerZ)) , _NoiseAmount ));
            }
            ENDCG
        }
    }
