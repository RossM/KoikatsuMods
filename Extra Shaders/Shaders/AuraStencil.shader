...
Shader "Custom/AuraStencil" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float GetLineWidth( float3 normal , float cameraDist , float detailMaskB , float linewidthG , float linewidthS ){
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += (GetLineWidth( v.normal , length((_WorldSpaceCameraPos-mul(unity_ObjectToWorld, v.vertex).rgb)) , _DetailMask_var.b , _linewidthG , _LineWidthS )*v.normal*recipObjScale);
