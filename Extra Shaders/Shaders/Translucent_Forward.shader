...
Shader "Custom/Translucent_Forward" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float3 _GetSpecular( float3 normal , float3 view , float4 specularColor , float specularPower ){
            return GetSpecular(normal, view, specularColor, specularPower);
            }
...
////// Emissive:
                ...
                float3 specularRGB = _GetSpecular( normalDirection , viewDirection , float4(_SpecularColor.rgb,_SpecularColor.a) , _SpecularPower );
