...
////// Emissive:
                ...
                float2 iridescenceUV = (lerp(float2(dot(lerp(i.tangentDir,OSITangent,_LocalSpaceIridescence),perturbedView),dot(lerp(i.bitangentDir,OSIBiangent,_LocalSpaceIridescence),perturbedView)),mul( UNITY_MATRIX_V, float4(rotateView2( halfDirection , viewDirection , normalDirection ),0) ).xyz.rgb.rg,_ViewSpaceIridescence)*0.5+0.5);
