    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 gradientUV = saturate(float2((GetAuraDistance( sceneUVs.rg , ((r*0.1+0.0)*(1.0 / centerZ)) )/(((_NoiseTex_var.r*2.0+-1.0)*_NoiseAmount)+1.0)),0.0));
