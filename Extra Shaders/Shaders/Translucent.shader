...
////// Emissive:
                ...
                float3 rimRGB = saturate(((saturate((_rimColor.rgb > 0.5 ?  (1.0-(1.0-2.0*(_rimColor.rgb-0.5))*(1.0-mainColorRGB)) : (2.0*_rimColor.rgb*mainColorRGB)) )*_rimColor.a)*_rimV*rimValue*lerp(float3(1,1,1),shadowRGB,saturate((1.0 - lighting)))));
