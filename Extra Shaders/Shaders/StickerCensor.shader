    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip((step(_AlphaCutoff,alpha)*CheckShadowcaster()) - 0.5);
////// Lighting:
////// Emissive:
