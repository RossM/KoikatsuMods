...
////// Emissive:
                float lighting = (attenuation*_GetRamp( normalDirection , lightDirection , _AnotherRamp , _AnotherRampFull ));
                float3 shadowRGB = lerp(_GetAdjustedShadowColor( float4(_ShadowColor.rgb,_ShadowColor.a) ),float3(1,1,1),lighting);
