...
////// Emissive:
                ...
                float3 baseRGB = (lerp(lightRGB,float3(1,1,1),_ShadowsOnBackground)*lerp(_MainTex_var.rgb,matcapRGB,_MatcapAlpha)*mainColorRGB);
                ...
                float3 rimRGB = _GetRimLight( normalDirection , viewDirection , (saturate((_rimColor.rgb > 0.5 ?  (1.0-(1.0-2.0*(_rimColor.rgb-0.5))*(1.0-mainColorRGB)) : (2.0*_rimColor.rgb*mainColorRGB)) )*_rimColor.a) , _rimpower , _rimV , 0.0 , lightRGB );
