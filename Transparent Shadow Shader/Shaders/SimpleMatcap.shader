    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 viewNormal = mul( UNITY_MATRIX_V, float4(normalDirection,0) ).xyz;
                float2 viewXY = viewNormal.rgb.rg;
                float2 matcapUV = (lerp(viewXY,normalize(viewXY),step(viewNormal.rgb.b,0.0))*0.5+0.5);
