...
/*SF_DATA;ver:1.35;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:0,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:2659,x:32951,y:32653,varname:node_2659,prsc:2|normal-6900-OUT,emission-3538-OUT;n:type:ShaderForge.SFN_Tex2d,id:2310,x:31291,y:32956,ptovrint:False,ptlb:DetailMask,ptin:_DetailMask,varname:_DetailMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:2,isnm:False;n:type:ShaderForge.SFN_Lerp,id:3693,x:31510,y:32757,varname:node_3693,prsc:2|A-4034-RGB,B-2310-RGB,T-1481-OUT;n:type:ShaderForge.SFN_Tex2d,id:8731,x:31510,y:32956,ptovrint:False,ptlb:ColorMask,ptin:_ColorMask,varname:_ColorMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:3341,x:31706,y:32757,varname:node_3341,prsc:2|A-3693-OUT,B-8731-RGB,T-882-OUT;n:type:ShaderForge.SFN_Tex2d,id:4034,x:31291,y:32700,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:_MainTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:9898,x:31706,y:32956,ptovrint:False,ptlb:NormalMap,ptin:_NormalMap,varname:_NormalMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Lerp,id:3678,x:31906,y:32757,varname:node_3678,prsc:2|A-3341-OUT,B-9898-RGB,T-1555-OUT;n:type:ShaderForge.SFN_ToggleProperty,id:1555,x:31706,y:33221,ptovrint:False,ptlb:UseNormalMap,ptin:_UseNormalMap,varname:_UseNormalMap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_ToggleProperty,id:1481,x:31291,y:33221,ptovrint:False,ptlb:UseDetailMask,ptin:_UseDetailMask,varname:_UseDetailMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_ToggleProperty,id:882,x:31510,y:33221,ptovrint:False,ptlb:UseColorMask,ptin:_UseColorMask,varname:_UseColorMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_Divide,id:3114,x:30654,y:33557,varname:matcapPre,prsc:2|A-7442-OUT,B-5079-OUT;n:type:ShaderForge.SFN_Length,id:5079,x:30462,y:33557,varname:node_5079,prsc:2|IN-2828-OUT;n:type:ShaderForge.SFN_ComponentMask,id:7442,x:30462,y:33355,varname:node_7442,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-1969-OUT;n:type:ShaderForge.SFN_Add,id:2828,x:30268,y:33557,varname:node_2828,prsc:2|A-1969-OUT,B-9905-OUT;n:type:ShaderForge.SFN_Vector3,id:9905,x:30034,y:33586,varname:node_9905,prsc:2,v1:0,v2:0,v3:1;n:type:ShaderForge.SFN_Tex2d,id:4223,x:32089,y:32955,ptovrint:False,ptlb:Matcap,ptin:_Matcap,varname:_Matcap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False|UVIN-1649-OUT;n:type:ShaderForge.SFN_ToggleProperty,id:6249,x:32089,y:33220,ptovrint:False,ptlb:UseMatcap,ptin:_UseMatcap,varname:_UseMatcap,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_Lerp,id:2081,x:32297,y:32756,varname:node_2081,prsc:2|A-4593-OUT,B-4223-RGB,T-6249-OUT;n:type:ShaderForge.SFN_Tex2d,id:9160,x:32297,y:32955,ptovrint:False,ptlb:LineMask,ptin:_LineMask,varname:_LineMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_ToggleProperty,id:7426,x:32297,y:33220,ptovrint:False,ptlb:UseLineMask,ptin:_UseLineMask,varname:_UseLineMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_Lerp,id:4174,x:32497,y:32756,varname:node_4174,prsc:2|A-2081-OUT,B-9160-RGB,T-7426-OUT;n:type:ShaderForge.SFN_Lerp,id:3538,x:32687,y:32756,varname:node_3538,prsc:2|A-4174-OUT,B-1419-RGB,T-2831-OUT;n:type:ShaderForge.SFN_Tex2d,id:1419,x:32497,y:32955,ptovrint:False,ptlb:AlphaMask,ptin:_AlphaMask,varname:_AlphaMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_ToggleProperty,id:2831,x:32497,y:33220,ptovrint:False,ptlb:UseAlphaMask,ptin:_UseAlphaMask,varname:_UseAlphaMask,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_RemapRange,id:3150,x:31705,y:33562,varname:node_333,prsc:2,frmn:-1,frmx:1,tomn:0,tomx:1|IN-9698-OUT;n:type:ShaderForge.SFN_Relay,id:6900,x:32078,y:32682,varname:node_6900,prsc:2|IN-9898-RGB;n:type:ShaderForge.SFN_Lerp,id:361,x:30931,y:33560,varname:viewSpaceReflection,prsc:2|A-3114-OUT,B-4160-OUT,T-8475-OUT;n:type:ShaderForge.SFN_ToggleProperty,id:8475,x:30654,y:33830,ptovrint:False,ptlb:MatcapMode,ptin:_MatcapMode,varname:_MatcapMode,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_Lerp,id:4593,x:32089,y:32756,varname:node_4593,prsc:2|A-3678-OUT,B-1649-OUT,T-8806-OUT;n:type:ShaderForge.SFN_ToggleProperty,id:8806,x:31903,y:33220,ptovrint:False,ptlb:UseMatcapUV,ptin:_UseMatcapUV,varname:_UseMatcapUV,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False;n:type:ShaderForge.SFN_NormalVector,id:5900,x:29033,y:33135,prsc:2,pt:True;n:type:ShaderForge.SFN_Transform,id:3098,x:29234,y:33135,varname:node_3098,prsc:2,tffrom:0,tfto:3|IN-5900-OUT;n:type:ShaderForge.SFN_Reflect,id:1969,x:30034,y:33348,cmnt:This is the matcap mode used by Better Matcap. It better takes into account the view angle but has weird artifacts around the edges.,varname:viewReflectionPosition,prsc:2|A-8599-OUT,B-8157-OUT;n:type:ShaderForge.SFN_Code,id:8599,x:29579,y:33349,varname:node_8599,prsc:2,code:cgBlAHQAdQByAG4AIABtAHUAbAAoAFUATgBJAFQAWQBfAE0AQQBUAFIASQBYAF8AVgAsACAAZgBsAG8AYQB0ADQAKABwAG8AcwBXAG8AcgBsAGQALgB4AHkAegAgAC0AIABfAFcAbwByAGwAZABTAHAAYQBjAGUAQwBhAG0AZQByAGEAUABvAHMALgB4AHkAegAsACAAMQApACkAOwA=,output:2,fname:ViewSpacePosition,width:247,height:132,input:2,input_1_label:posWorld|A-8308-XYZ;n:type:ShaderForge.SFN_FragmentPosition,id:8308,x:29340,y:33336,varname:node_8308,prsc:2;n:type:ShaderForge.SFN_Clamp01,id:1649,x:31908,y:33562,varname:matcapUV,prsc:2|IN-3150-OUT;n:type:ShaderForge.SFN_ComponentMask,id:6467,x:30654,y:33955,varname:node_6467,prsc:2,cc1:2,cc2:-1,cc3:-1,cc4:-1|IN-9615-OUT;n:type:ShaderForge.SFN_Vector1,id:5580,x:30654,y:34142,varname:node_5580,prsc:2,v1:0;n:type:ShaderForge.SFN_Normalize,id:661,x:30931,y:33721,varname:node_661,prsc:2|IN-4160-OUT;n:type:ShaderForge.SFN_Set,id:6529,x:29421,y:33135,varname:viewNormal,prsc:2|IN-3098-XYZ;n:type:ShaderForge.SFN_Get,id:8157,x:29706,y:33541,varname:node_8157,prsc:2|IN-6529-OUT;n:type:ShaderForge.SFN_Get,id:9615,x:30441,y:33955,varname:node_9615,prsc:2|IN-6529-OUT;n:type:ShaderForge.SFN_Get,id:7432,x:30247,y:33756,varname:node_7432,prsc:2|IN-6529-OUT;n:type:ShaderForge.SFN_ComponentMask,id:4160,x:30462,y:33756,varname:viewXY,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-7432-OUT;n:type:ShaderForge.SFN_Step,id:4686,x:30931,y:33952,varname:node_4686,prsc:2|A-6467-OUT,B-5580-OUT;n:type:ShaderForge.SFN_Lerp,id:9698,x:31157,y:33560,varname:node_9698,prsc:2|A-361-OUT,B-661-OUT,T-4686-OUT;proporder:4034-2310-8731-9898-4223-9160-1419-1555-1481-882-6249-7426-2831-8475-8806;pass:END;sub:END;*/
...
////// Emissive:
                ...
                float3 viewReflectionPosition = reflect(ViewSpacePosition( i.posWorld.rgb ),viewNormal); // This is the matcap mode used by Better Matcap. It better takes into account the view angle but has weird artifacts around the edges.
                float2 viewXY = viewNormal.rg;
                float2 matcapUV = saturate((lerp(lerp((viewReflectionPosition.rg/length((viewReflectionPosition+float3(0,0,1)))),viewXY,_MatcapMode),normalize(viewXY),step(viewNormal.b,0.0))*0.5+0.5));
                ...
                float3 emissive = lerp(lerp(lerp(lerp(lerp(lerp(lerp(_MainTex_var.rgb,_DetailMask_var.rgb,_UseDetailMask),_ColorMask_var.rgb,_UseColorMask),_NormalMap_var.rgb,_UseNormalMap),float3(matcapUV,0.0),_UseMatcapUV),_Matcap_var.rgb,_UseMatcap),_LineMask_var.rgb,_UseLineMask),_AlphaMask_var.rgb,_UseAlphaMask);
