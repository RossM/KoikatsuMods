...
////// Emissive:
                ...
                float2 textureRelativeSpecular = (mul(float2(dot(halfDirection,i.tangentDir),dot(halfDirection,i.bitangentDir))-textureRelativeSpecular_piv,float2x2( textureRelativeSpecular_cos, -textureRelativeSpecular_sin, textureRelativeSpecular_sin, textureRelativeSpecular_cos))+textureRelativeSpecular_piv);
