...
////// Emissive:
                ...
                float2 node_104 = float2(dot(normalDirection,lightDirection),0.0);
                float4 _RampG_var = tex2D(_RampG,TRANSFORM_TEX(node_104, _RampG));
