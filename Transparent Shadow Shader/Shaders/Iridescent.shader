...
////// Emissive:
                ...
                float node_7621 = ((1.0 - (detailMaskG*(shadowStrength*-0.5+1.5)))*_rimV*rimValue);
                float3 rimRGB = saturate(lerp(_rimColor.rgb,float3(1,1,1),(node_7621*1.0+-1.0)));
