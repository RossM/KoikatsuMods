...
////// Lighting:
                ...
                float detailShadow = (1.0 - DetailMaskG);
                ...
                float3 finalColor = ((textureRGB*_LightColor0.rgb*lerp(float4(1,1,1,1),float4(_ShadowColor.rgb,0.0),((1.0 - (_RampG_var.r*detailShadow*attenuation))*2.0*(1.0 - _ambientshadowG.a))))+glossRGB).rgb;
