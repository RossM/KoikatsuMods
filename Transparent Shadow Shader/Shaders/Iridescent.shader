...
////// Lighting:
                ...
                float2 iridescenceUV = (i.uv0+(float2(dot(halfDirection,i.tangentDir),dot(halfDirection,i.bitangentDir))*_IridescenceScale));
                ...
                float iridescenceFactor = (pow((dot(viewReflectDirection,lightDirection)*0.5+0.5),(_IridescencePower+1.0))*brightness*_IridescenceAlpha);
