...
////// Lighting:
                ...
                float3 baseColor = (lerp( lerp( lerp( float4(1,1,1,1).rgb, _Color.rgb, _ColorMask_var.rgb.r ), _Color2.rgb, _ColorMask_var.rgb.g ), _Color3.rgb, _ColorMask_var.rgb.b ));
                ...
                float3 colorRGB = lerp(baseColor,(baseColor*shadowColorRGB),DetailMaskG).rgb;
                ...
                float3 finalColor = ((textureRGB*_LightColor0.rgb*lerp(float4(shadowColorRGB,0.0),float4(1,1,1,1),brightness))+glossRGB).rgb;
