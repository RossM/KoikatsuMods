...
////// Emissive:
                ...
                float lightValue = (_RampG_var.r*attenuation);
                float brightness = min((1.0 - detailMaskG),lerp((_ShadowExtend*-0.5+0.0),1.0,lightValue));
